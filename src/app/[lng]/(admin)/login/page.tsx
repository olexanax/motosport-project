...
const LoginPage = () => {
  ...
  const isLogining = useSelector((state: RootStateType) => state.login.isLoginLoading)
      ...
      <div className={styles.content}>
        ...
        <form className={styles.form} onSubmit={handleSubmit(submitForm)}>
          <div className={styles.inputBlock}>
            ...
            <input type='text' {...register("username", { required: true })} className={styles.input} />
          </div>
          <div className={styles.inputBlock}>
            <p className={styles.label}>
              Password
          ...
          <input disabled={isLogining || !isValid} type="submit" value={`${isLogining ? "Loading..." : "Sign In"}`} className={classNames(styles.btn, global.primaryButton)} />
